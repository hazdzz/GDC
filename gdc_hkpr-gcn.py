...
def get_parameters():
    ...
    return device, dataset, model_name, gso_type, t, lr, weight_decay, droprate, n_hid, enable_bias, K, epochs, opt, patience, model_save_path
...
if __name__ == "__main__":
    device, dataset, model_name, gso_type, t, lr, weight_decay, droprate, n_hid, enable_bias, K, epochs, opt, patience, model_save_path = get_parameters()
